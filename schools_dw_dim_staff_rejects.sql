...
--
-- Table structure for table `dim_staff_rejects`
--

DROP TABLE IF EXISTS `dim_staff_rejects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dim_staff_rejects` (
  `Rejects_sk` int(11) NOT NULL AUTO_INCREMENT,
  `staff_state_number` int(11) DEFAULT NULL,
  ...
  `DI_Reject_Code` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `dim_staff_rejects`
--

LOCK TABLES `dim_staff_rejects` WRITE;
/*!40000 ALTER TABLE `dim_staff_rejects` DISABLE KEYS */;
/*!40000 ALTER TABLE `dim_staff_rejects` ENABLE KEYS */;
UNLOCK TABLES;
