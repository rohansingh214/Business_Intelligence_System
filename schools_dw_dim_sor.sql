...
--
-- Table structure for table `dim_sor`
--
...
CREATE TABLE `dim_sor` (
  ...
  `SOR_Table_Name` char(80) DEFAULT NULL,
...
--
-- Dumping data for table `dim_sor`
--

LOCK TABLES `dim_sor` WRITE;
/*!40000 ALTER TABLE `dim_sor` DISABLE KEYS */;
/*!40000 ALTER TABLE `dim_sor` ENABLE KEYS */;
UNLOCK TABLES;
