...
--
-- Table structure for table `dim_geo_zip`
--

DROP TABLE IF EXISTS `dim_geo_zip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dim_geo_zip` (
...
--
-- Dumping data for table `dim_geo_zip`
--

LOCK TABLES `dim_geo_zip` WRITE;
/*!40000 ALTER TABLE `dim_geo_zip` DISABLE KEYS */;
/*!40000 ALTER TABLE `dim_geo_zip` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-10 23:36:07
